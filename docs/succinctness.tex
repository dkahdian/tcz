...
\begin{claim}
\langref{d-SDNNF} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langref{uOBDD} \citet{Amarilli_2018,Bollig_2018,Beame_2015}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langfam{d-SDNNF}{T} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langfam{uOBDD}{<} \citet{Amarilli_2018,Bollig_2018,Beame_2015,TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{dec-DNNF} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langref{FBDD} \citet{Beame_2013}
\end{claim}
\begin{claimdescription}
Corollary 3.2 of \citet{Beame_2013} show quasipolynomial compilation from \langref{dec-DNNF} to \langref{FBDD}
\end{claimdescription}
...
\begin{claim}
\langref{dec-SDNNF} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langref{OBDD} \citet{Amarilli_2018,Bollig_2018,Beame_2015}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langfam{dec-SDNNF}{T} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langfam{OBDD}{<} \citet{Amarilli_2018,Bollig_2018,Beame_2015,TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{DNF} is not quasipolynomial-time compilable to \langref{d-SDNNF} \citet{Amarilli_2018}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{DNNF} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langref{nFBDD} \citet{Bodlaender_1993}
\end{claim}
\begin{claimdescription}
Section 5 of \citet{Bodlaender_1993} extends the compilation of \langref{dec-DNNF}s into \langref{FBDD}s (shown in \citet{Beame_2013}) to show that \langref{DNNF} can be quasipolynomial-time compiled into \langref{nFBDD}.
\end{claimdescription}
...
\begin{claim}
\langref{nFBDD} is not quasipolynomial-time compilable to \langref{d-DNNF} \citet{Amarilli_2018}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{nFBDD} is not quasipolynomial-time compilable to \langref{FBDD} \citet{Amarilli_2018}
\end{claim}
\begin{claimdescription}
...
% separators=Sauerhoff
\begin{claim}
\langref{nFBDD} is not quasipolynomial-time compilable to \langref{uFBDD} \citet{Amarilli_2018}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{OBDD} is not quasipolynomial-time compilable to \langfam{SDNNF}{T} \citet{TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
For any fixed vtree $T$, a simple function can be chosen so that every \langfam{SDNNF}{T} representation is exponentially large, while some \langref{OBDD} represents it in linear size. Therefore \langref{OBDD} cannot compile to \langfam{SDNNF}{T} in quasipolynomial size \citet{TCZ_Forthcoming}.
\end{claimdescription}
...
\begin{claim}
\langref{SDNNF} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langref{nOBDD} \citet{Bollig_2018,Beame_2015}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langfam{SDNNF}{T} has unknown polynomial-time (but has quasipolynomial-time) compilation to \langfam{nOBDD}{<} \citet{Amarilli_2018,Bollig_2018,Beame_2015,TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{uFBDD} is not quasipolynomial-time compilable to \langref{FBDD} \citet{Bova_2016,Amarilli_2018,Wegener_2000}
\end{claim}
\begin{claimdescription}
...
% separators=Parity
\begin{claim}
\langref{CNF} is not quasipolynomial-time compilable to \langref{PI} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
% separators=$OR_n$
\begin{claim}
\langref{d-DNNF} is not quasipolynomial-time compilable to \langref{MODS} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
% separators=Parity
\begin{claim}
\langref{DNF} is not quasipolynomial-time compilable to \langref{IP} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{IP} is not quasipolynomial-time compilable to \langref{CNF} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
% separators=Clique
\begin{claim}
\langref{IP} is not quasipolynomial-time compilable to \langref{FBDD} \citet{Darwiche_2002,Wegener_1987}
\end{claim}
\begin{claimdescription}
...
% separators=$OR_n$
\begin{claim}
\langref{IP} is not quasipolynomial-time compilable to \langref{MODS} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
% separators=Parity
\begin{claim}
\langfam{OBDD}{<} is not quasipolynomial-time compilable to \langref{CNF} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
% separators=Parity
\begin{claim}
\langfam{OBDD}{<} is not quasipolynomial-time compilable to \langref{DNF} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{PI} is not quasipolynomial-time compilable to \langref{DNF} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
% separators=Clique
\begin{claim}
\langref{PI} is not quasipolynomial-time compilable to \langref{FBDD} \citet{Wegener_1987,Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
% separators=$OR_n$
\begin{claim}
\langref{PI} is not quasipolynomial-time compilable to \langref{MODS} \citet{Darwiche_2002}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langfam{cSDD}{T} is not quasipolynomial-time compilable to \langfam{OBDD}{<} \citet{Bova_2016_a,Bryant_1986,Wegener_2000}
\end{claim}
\begin{claimdescription}
...
% separators=$EQ_n$
\begin{claim}
\langref{OBDD} is not quasipolynomial-time compilable to \langfam{OBDD}{<} \citet{Wegener_2000}
\end{claim}
\begin{claimdescription}
Suppose an order $<$ existed so that \langref{OBDD} compiled to \langfam{OBDD}{<}. Take the first $2n$ variables in that order, call the first half $x_1,\ldots,x_n$ and the second half $y_1,\ldots,y_n$, and consider $EQ_n(x,y)$. This function has linear-size OBDDs under the interleaved order $x_1,y_1,\ldots,x_n,y_n$, but exponential-size \langfam{OBDD}{<} representations \citet{Wegener_2000}. Thus no order $<$ can exist, and \langref{OBDD} is not quasipolynomial-time compilable to \langfam{OBDD}{<}.
\end{claimdescription}

% separators=$WS_n$
\begin{claim}
\langref{uOBDD} is not quasipolynomial-time compilable to \langref{FBDD} \citet{Wegener_2000,Savicky_Zak_1996}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langfam{SDD}{T} is not quasipolynomial-time compilable to \langref{FBDD} \citet{Bollig_2018}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langref{FBDD} is not quasipolynomial-time compilable to \langref{SDD} \citet{Beame_2015}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langref{d-DNNF} is not quasipolynomial-time compilable to \langref{dec-DNNF} \citet{Beame_2013}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langref{CNF} is not quasipolynomial-time compilable to \langref{DNNF} \citet{Bova_2014}
\end{claim}
\begin{claimdescription}
Theorem 1 of \citet{Bova_2014} gives a family of \langref{CNF} formulas whose every \langref{DNNF} representation has exponential size, so \langref{CNF} cannot compile to \langref{DNNF} in quasipolynomial size.
\end{claimdescription}
...
% separators=Sauerhoff
\begin{claim}
\langref{DNNF} is not quasipolynomial-time compilable to \langref{d-DNNF} \citet{Bova_2016}
\end{claim}
\begin{claimdescription}
...
% separators=JS
\begin{claim}
\langref{PI} is not quasipolynomial-time compilable to \langref{DNNF} \citet{Bova_2016}
\end{claim}
\begin{claimdescription}
Proposition 11 of \citet{Bova_2016} shows that the $JS_n$ has \langref{PI} size $O(n^2)$. Proposition 12 of \citet{Bova_2016} shows that $JS_n$ has \langref{DNNF} size $2^{\Omega(n^2)}$.
\end{claimdescription}
...
% separators=Generalized_HWB
\begin{claim}
\langfam{cSDD}{T} is not quasipolynomial-time compilable to \langref{OBDD} \citet{Bova_2016_a}
\end{claim}
\begin{claimdescription}
Theorem 4 of \citet{Bova_2016_a} constructs a generalized hidden weighted bit function $F_n$ with polynomial-size compressed SDDs respecting explicit vtrees, but every \langref{OBDD} for $F_n$ has size $2^{\Omega(n)}$. Hence \langfam{cSDD}{T} is not quasipolynomial-time compilable to \langref{OBDD}.
\end{claimdescription}

% separators=Generalized_HWB
\begin{claim}
\langref{cSDD} is not quasipolynomial-time compilable to \langref{OBDD} \citet{Bova_2016_a}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langref{d-DNNF} is not quasipolynomial-time compilable to \langref{FBDD} \citet{Darwiche_2000}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langref{DNF} is not quasipolynomial-time compilable to \langref{OBDD} \citet{Devadas_1993}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langref{FBDD} is not quasipolynomial-time compilable to \langref{SDNNF} \citet{Capelli_2016,Pipatsrisawat_2010}
\end{claim}
\begin{claimdescription}
...
% separators=HWB
\begin{claim}
\langref{FBDD} is not quasipolynomial-time compilable to \langref{OBDD} \citet{Gergov_1994}
\end{claim}
\begin{claimdescription}
