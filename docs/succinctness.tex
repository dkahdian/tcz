...
\begin{claim}
\langfam{d-SDNNF}{T} has unknown polynomial-time (but has quasi-polynomial-time) compilation to \langfam{uOBDD}{<} \citet{Amarilli_2018,Bollig_2018,Beame_2015,TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langfam{dec-SDNNF}{T} has unknown polynomial-time (but has quasi-polynomial-time) compilation to \langfam{OBDD}{<} \citet{Amarilli_2018,Bollig_2018,Beame_2015,TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
...
\begin{claim}
\langref{OBDD} is not quasi-polynomial-time compilable to \langfam{SDNNF}{T} \citet{TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
For any fixed vtree $T$, a simple function can be chosen so that every \langfam{SDNNF}{T} representation is exponentially large, while some \langref{OBDD} represents it in linear size. Therefore \langref{OBDD} cannot compile to \langfam{SDNNF}{T} in quasi-polynomial size \citet{TCZ_Forthcoming}.
\end{claimdescription}
...
\begin{claim}
\langfam{SDNNF}{T} has unknown polynomial-time (but has quasi-polynomial-time) compilation to \langfam{nOBDD}{<} \citet{Amarilli_2018,Bollig_2018,Beame_2015,TCZ_Forthcoming}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
\langref{CNF} is not quasi-polynomial-time compilable to \langref{DNNF} \citet{Bova_2014}
\end{claim}
\begin{claimdescription}
Theorem 1 of \citet{Bova_2014} gives a family of \langref{CNF} formulas whose every \langref{DNNF} representation has exponential size, so \langref{CNF} cannot compile to \langref{DNNF} in quasi-polynomial size.
\end{claimdescription}
...
% separators=Generalized_HWB
\begin{claim}
\langfam{cSDD}{T} is not quasi-polynomial-time compilable to \langref{OBDD} \citet{Bova_2016_a}
\end{claim}
\begin{claimdescription}
Theorem 4 of \citet{Bova_2016_a} constructs a generalized hidden weighted bit function $F_n$ with polynomial-size compressed SDDs respecting explicit vtrees, but every \langref{OBDD} for $F_n$ has size $2^{\Omega(n)}$. Hence \langfam{cSDD}{T} is not quasi-polynomial-time compilable to \langref{OBDD}.
\end{claimdescription}
